...
export default function Home () {
  ...
  const validatorApiUrl = 'http://127.0.0.1:8080/api/v1/proof'
  ...
  async function fetchGreeting () {
    ...
    // }
    // let response = await fetch('http://localhost:8080/api/v1/proof', {
  ...
  return (
    <div className='max-w-lg mt-36 mx-auto text-center px-4'>
      <Head>
        ...
        <meta
          name='description'
          content='Women Safety Application to travel and track'
        />
